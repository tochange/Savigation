...
public class ListToAdapter
{
    ...
    {
        // first method:load together,no so long time,no need to
        // notifyDataSetChanged in myNotify()
        // AppData.getAppList(c, appList);

        // second method:load every one in child Thread handle in main Thread
