...
public class AppMsg {
     ...
     * @see #setDuration
     */
    public static final int LENGTH_SHORT = 1500;//3000;
     ...
     */
    public static AppMsg makeText(Activity context, CharSequence text, int textcolor,Style style) {
        return makeText(context, text, textcolor,style, R.layout.app_msg);
    }
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(Activity context, CharSequence text,int textcolor, Style style, float textSize) {
        return makeText(context, text,textcolor, style, R.layout.app_msg, textSize);
    }
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(Activity context, CharSequence text,int textcolor, Style style, int layoutId) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);

        return makeText(context, text,textcolor, style, v, true);
    }
     ...
     * @param style   The style with a background and a duration.
     */
    public static AppMsg makeText(Activity context, CharSequence text,int textcolor, Style style, int layoutId, float textSize) {
        LayoutInflater inflate = (LayoutInflater)
                context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View v = inflate.inflate(layoutId, null);

        return makeText(context, text,textcolor, style, v, true, textSize);
    }
     ...
     * @param style    The style with a background and a duration.
     */
    public static AppMsg makeText(Activity context, CharSequence text,int textcolor,Style style, View customView) {
       return makeText(context, text,textcolor, style, customView, false);
    }
     ...
     */
    private static AppMsg makeText(Activity context, CharSequence text, int textcolor,Style style, View view, boolean floating) {
        return makeText(context, text,textcolor, style, view, floating, 0);
    }
     ...
     * @param floating true if it'll float.
     */
    private static AppMsg makeText(Activity context, CharSequence text,int textcolor, Style style, View view, boolean floating, float textSize) {
     ...
     * @param floating true if it'll float.
     */
    public static AppMsg makeText(Activity context, int resId,int textcolor, Style style, View customView, boolean floating) {
        return makeText(context, context.getResources().getText(resId), textcolor,style, customView, floating);
    }
     ...
     */
    public static AppMsg makeText(Activity context, int resId, int textcolor,Style style)
            throws Resources.NotFoundException {
        return makeText(context, context.getResources().getText(resId), textcolor,style);
    }
     ...
     * @throws Resources.NotFoundException if the resource can't be found.
     */
    public static AppMsg makeText(Activity context, int resId,int textcolor, Style style, int layoutId)
            throws Resources.NotFoundException {
        return makeText(context, context.getResources().getText(resId),textcolor, style, layoutId);
    }
