...
public class MainView extends RelativeLayout
{
    ...
    /**
     * index of handle close action,integer number,bigger than mChildrenList's
     * size
     */
    ...
    private void rotate()
    {
        ...
        aniback.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation)
            {
                ...
                doFatherListener();
                MainView.this.startAnimation(AnimationUtils.loadAnimation(
                        mContext, R.anim.rotate_font));
            }
        });
        MainView.this.startAnimation(aniback);
    }
