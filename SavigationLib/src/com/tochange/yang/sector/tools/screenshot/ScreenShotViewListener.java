...
public class ScreenShotViewListener implements OnTouchListener
{
    ...
    public ScreenShotViewListener(Context c, String[] file, ImageView imageView)
    {
        mContext = c;
        mFile = file;
        mShowCutImageView = imageView;
    }
    ...
    public boolean onTouch(View v, MotionEvent event)
    {
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK)
        {
            ...
            case MotionEvent.ACTION_DOWN:
                mode = MODE_DRAG;
                // 记录ImageView当前的移动位置
                currentMatrix.set(mShowCutImageView.getImageMatrix());
        ...
        mShowCutImageView.setImageMatrix(matrix);
        return true;
    }
