...
extern "C" {
   JNIEXPORT jbyteArray JNICALL Java_com_tochange_yang_sector_tools_numberlocation_NativeFunction_getLocationFromJni(JNIEnv* env,jclass tis,jstring filename,jstring number);
};
